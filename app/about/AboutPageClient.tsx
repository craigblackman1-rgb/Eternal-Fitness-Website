        ...
        <div className="max-w-[1320px] mx-auto">
          <div className="grid md:grid-cols-[5fr_6fr] gap-12 md:gap-20 items-center">
            <div className="relative">
              <div className="relative rounded-3xl overflow-hidden aspect-[3/4] shadow-[0_32px_80px_rgba(0,0,0,0.12)]">
                <img src="/images/esther-about.jpg" alt="Esther Fair, personal trainer at Eternal Fitness Worthing" loading="lazy" className="w-full h-full object-cover" />
              </div>
              <div className="absolute -bottom-5 -right-4 bg-rose rounded-2xl px-6 py-5 text-white shadow-[0_16px_40px_rgba(193,131,159,0.35)] text-center z-10">
                <div className="text-4xl font-black leading-none mb-0.5">L4</div>
                <div className="text-[10px] font-bold tracking-[0.06em] uppercase opacity-80">Qualified</div>
              </div>
            </div>
            <div>
        ...
        <div className="max-w-[1320px] mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            {qualifications.map((q) => (
              <div key={q.title} className="ef-card">
                ...
                <h4 className="text-foreground text-lg font-bold tracking-tight mb-2">{q.title}</h4>
                <p className="ef-body text-sm">{q.desc}</p>
              </div>
            ))}
          </div>
        </div>
