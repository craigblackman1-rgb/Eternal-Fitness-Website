    ...
    <div className="min-h-screen bg-background">
      ...
      <section id="story" className="py-20 md:py-28 px-6 md:px-12 bg-background">
        <div className="max-w-6xl mx-auto">
          <div className="flex justify-center mb-6"><span className="inline-flex items-center gap-2 bg-rose text-white px-4 py-1.5 rounded-xl text-sm font-semibold">✦ My Story</span></div>
      ...
      <section className="py-20 md:py-28 bg-white">
        <div className="max-w-6xl mx-auto px-6 md:px-12">
          <div className="text-center mb-14">
            <span className="inline-flex items-center gap-2 bg-rose text-white px-4 py-1.5 rounded-xl text-sm font-semibold mb-4">✦ Qualifications</span>
      ...
      <section className="py-20 md:py-28 px-6 md:px-12 bg-background">
        <div className="max-w-6xl mx-auto">
          <div className="flex justify-center mb-6"><span className="inline-flex items-center gap-2 bg-rose text-white px-4 py-1.5 rounded-xl text-sm font-semibold">✦ Experience</span></div>
      ...
      {/* Philosophy */}
      <section id="philosophy" className="py-20 md:py-28 bg-white">
        <div className="max-w-6xl mx-auto px-6 md:px-12">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <span className="inline-flex items-center gap-2 bg-rose text-white px-4 py-1.5 rounded-xl text-sm font-semibold mb-4">✦ Philosophy</span>
      ...
      <section className="py-20 md:py-28 bg-warm">
        <div className="max-w-6xl mx-auto px-6 md:px-12">
          <div className="text-center mb-14">
            ...
            <h2 className="text-3xl md:text-4xl text-foreground mb-4">A Private Space in Worthing</h2>
            <p className="text-muted-foreground font-body text-base max-w-2xl mx-auto">Sessions take place in a small, private, fully equipped studio. No public gym floor. No other clients watching. No ambient pressure of what anyone else around you is doing.</p>
          </div>
          <div className="grid md:grid-cols-2 gap-6 mb-10">
            <img src="/images/studio-1.jpg" alt="Eternal Fitness private training studio Worthing" loading="lazy" className="rounded-2xl w-full h-72 object-cover shadow-sm" />
            <img src="/images/studio-2.jpg" alt="Training equipment at Eternal Fitness Worthing" loading="lazy" className="rounded-2xl w-full h-72 object-cover shadow-sm" />
          </div>
          <div className="bg-white border border-border rounded-2xl p-6 md:p-8 max-w-2xl shadow-sm">
            <h4 className="text-foreground text-lg mb-2">Built for All Abilities</h4>
            <p className="text-muted-foreground font-body text-base leading-relaxed">The studio is set up specifically for people with disabilities, mobility limitations, and complex health needs. Equipment is chosen to support functional recovery and movement — not performance aesthetics. The environment is deliberately calm, because the last thing someone managing a health condition or in recovery needs is more pressure or noise.</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 md:py-28 px-6 md:px-12 bg-background">
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row md:items-end md:justify-between mb-14 gap-6">
            <div>
              <span className="inline-flex items-center gap-2 bg-rose text-white px-4 py-1.5 rounded-xl text-sm font-semibold mb-4">✦ Long-Term Progress</span>
