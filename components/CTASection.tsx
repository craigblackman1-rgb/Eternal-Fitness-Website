      ...
      <div className="grid md:grid-cols-2 min-h-[420px]">
        ...
        <div className="bg-primary flex items-center px-8 md:px-16 py-12 md:py-0">
          <div>
            ...
            <p className="text-primary-foreground/80 font-body text-base mb-8 max-w-md">
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <a href="tel:07517658128" className="inline-flex items-center gap-2 border border-primary-foreground/40 text-primary-foreground px-6 py-3 rounded-full font-medium hover:bg-primary-foreground/10 transition-colors">
